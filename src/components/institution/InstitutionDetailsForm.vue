<template>
  <v-card class="d-flex justify-space-between flex-column w-100 pa-4">
    ...
    <div class="d-flex flex-column justify-start mx-3 my-3 bloc-info">
      <v-text-field :label="t('institution.card.siren')" :placeholder="t('institution.card.siren')" variant="outlined"
        v-model="institution.siren" disabled class="mt-1" />
      <v-text-field :label="t('institution.card.institutionName')" :placeholder="t('institution.card.institutionName')"
        variant="outlined" v-model="institution.name" :disabled="isEditModeDisabled" class="mt-1" />
      <v-text-field :label="t('institution.card.idAbes')" :placeholder="t('institution.card.idAbes')" variant="outlined"
        v-model="institution.abesId" disabled class="mt-1" />
