        ...
        <v-col cols="10">
          <div style="padding: 20px;">
            ...
            <v-simple-table dense>
              <thead>
                <tr>
                  <th scope="col">{{ t("footer.privacy.cookiesTable.name") }}</th>
                  <th scope="col">{{ t("footer.privacy.cookiesTable.purpose") }}</th>
                  <th scope="col">{{ t("footer.privacy.cookiesTable.duration") }}</th>
                </tr>
              </thead>
              <tbody>
                <tr>
...
usePageMeta({
  titleKey: "footer.privacy.meta.title",
  descriptionKey: "footer.privacy.meta.description"
});
const { t } = useI18n();
